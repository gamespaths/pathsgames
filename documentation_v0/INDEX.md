...
| `Step28_MovementSystem.md` | **Biggest file.** Movement: adjacency, energy cost formula, validation order, fog-of-war, location cards, match logs timeline. | movement, adjacency, energy, fog-of-war, logs, ITEM_ADD, ITEM_USE, ITEM_DROP, MatchLogCard, itemAction |
