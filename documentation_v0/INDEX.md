...
| `Step18_GameMainFrontend.md` | react-game frontend: structure, design system, API client + mock fallback, guest identity. **v0.37.3**: status-card shortcuts named, force-sleep/registry actions dropped. | react-game, frontend, design system, GameBook, useBookView, PageRightMain, card-status |
