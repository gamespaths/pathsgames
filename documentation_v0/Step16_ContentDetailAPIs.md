...
- First version created with AI prompts:
    ...
    > I need to add CardInfo value in response APIs (join stories with cards):
        ...
        - /stories/group/{group}
        Please change java, python and aws-lambda projects code. 
