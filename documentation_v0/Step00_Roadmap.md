...
16. Story content APIs — cards, texts, and creators
    ...
    - Build frontend API client for cards, texts, and creators with TypeScript interfaces and data mapping (frontend)
