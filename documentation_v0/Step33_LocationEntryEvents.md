...
- **Document Version**: 0.35.6
  ...
  |---------|-------------|------|
  | 0.35.6 | `MovementStartResponse` and `SleepActionResponse` gain `edgeState` alongside their existing `automaticEvents[]`/`counterZero[]` payloads. New Robot case in `entry_triggers.robot`. Full writeup in [Step30_EdgeStates.md](./Step30_EdgeStates.md). | August 28, 2026 |
