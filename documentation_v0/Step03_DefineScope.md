# Paths Games V1 - Step 03: Scope Definition

This document defines the **scope definition** steps to build a **Paths Games**, an playable web-based game, with detailed requirements and scope for a V1 release.
...
- **Document Version**: 0.3.1
    ...
    | --- | --- | --- |
    | 0.3 | first version of documenti with points list | February 3, 2026 |
    | 0.3.1 | added licence and version control sections | February 5, 2026 |
