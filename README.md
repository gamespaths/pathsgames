...
| 0.17.0 | 🛠️ **Current version** | - ✅ [Implement guest login](./documentation_v0/Step12_GuestLoginMethod.md) & [Session & token management](Step13_SessionTokenManagement.md) <br />- ✅ [Stories magement](./documentation_v0/Step14_StoriesImportSystem.md) & [Stories contents](./documentation_v0/Step15_StoryContentAPIs.md) & [Content detail](./Step16_ContentDetailAPIs.md) & [Admin operations](./documentation_v0/Step17_StoryAdminCRUD.md)  <br />- 🚧 [**Version 0 Roadmap**](./documentation_v0/Step00_Roadmap.md) & [Developer branch](https://github.com/gamespaths/pathsgames/) 🏗️  |
