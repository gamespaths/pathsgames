...
- **Developer commands**:
    ...
    - **Frontend/React-admin**: Admin and content management system with stories, cards, entities, ... management.
        ...
        - [SonarCloud](https://sonarcloud.io/project/overview?id=games.paths%3Apaths-game-backend): [![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=games.paths%3Apaths-game-backend&metric=alert_status)](https://sonarcloud.io/summary/new_code?id=games.paths%3Apaths-game-backend) [![Bugs](https://sonarcloud.io/api/project_badges/measure?project=games.paths%3Apaths-game-backend&metric=bugs)](https://sonarcloud.io/summary/new_code?id=games.paths%3Apaths-game-backend) [![Coverage](https://sonarcloud.io/api/project_badges/measure?project=games.paths%3Apaths-game-backend&metric=coverage)](https://sonarcloud.io/summary/new_code?id=games.paths%3Apaths-game-backend) [![Vulnerabilities](https://sonarcloud.io/api/project_badges/measure?project=games.paths%3Apaths-game-backend&metric=vulnerabilities)](https://sonarcloud.io/summary/new_code?id=games.paths%3Apaths-game-backend) [![Security Rating](https://sonarcloud.io/api/project_badges/measure?project=games.paths%3Apaths-game-backend&metric=security_rating)](https://sonarcloud.io/summary/new_code?id=games.paths%3Apaths-game-backend)
