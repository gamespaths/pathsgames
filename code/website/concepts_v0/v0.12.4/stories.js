/* =============================================
   PATHS GAMES — stories.js
   All story catalog data, world locations,
   neighboring locations and available actions.
   Loaded before main.js.
   =============================================
   To add a new story:
     1. Add an entry to STORIES[] with a unique id and startLocation
     2. Add STORIES_LOCATIONS[yourId] = { locationId: { ... }, ... }
   Each location must have:
     - id, title, icon (FA class), iconColor, emote, image, desc
     - neighbors: array of location ids reachable from this location
     - actions: array of { id, icon, emote, title, desc }
   ============================================= */
