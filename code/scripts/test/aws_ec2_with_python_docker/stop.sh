...
#
# PYTHON twin of aws_ec2_with_java_docker/stop.sh (server3). Backend-agnostic:
# it only reads the .state file written by this folder's start.sh.
...
echo ""
echo "==================================================="
echo "  Paths Games PYTHON EC2 instance DESTROYED"
echo "==================================================="
