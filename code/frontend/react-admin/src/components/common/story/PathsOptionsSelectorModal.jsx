...
export default function PathsOptionsSelectorModal({
  ...
  return (
    <div className="pg-modal-backdrop" role="presentation" onClick={e => { if (e.target === e.currentTarget) onClose() }} data-testid="modal-backdrop">
      <div className="pg-modal" style={{ maxWidth: 800, width: '95vw' }}>
