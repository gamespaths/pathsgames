...
public class AdminConstant {
    ...
    public static final String KEY_DELETED_COUNT = "deletedCount";

    public static final String STORY_ALREADY_EXISTS = "STORY_ALREADY_EXISTS";
    public static final String STORY_NOT_FOUND = "STORY_NOT_FOUND";
    public static final String INVALID_STORY_DATA = "INVALID_STORY_DATA";
