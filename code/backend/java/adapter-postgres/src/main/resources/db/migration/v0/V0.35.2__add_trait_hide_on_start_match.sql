-- =============================================
-- Paths Games - Database Schema V0.35.2 (PostgreSQL)
...
COMMENT ON COLUMN list_traits.hide_on_start_match IS '1 = never offered at character creation and refused if selected; 0/NULL = pickable. An event or item may grant it either way';
