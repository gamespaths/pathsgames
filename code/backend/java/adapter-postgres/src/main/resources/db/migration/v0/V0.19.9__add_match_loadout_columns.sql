...
-- Add player-choice loadout columns to gaming_match (PostgreSQL)
...
-- UUIDs are stored loosely (no FK) because the character/class/trait
-- selection engine ships in Steps 21-23.
-- =============================================
...
ALTER TABLE gaming_match ADD COLUMN character_template_uuid VARCHAR(36);
ALTER TABLE gaming_match ADD COLUMN class_uuid              VARCHAR(36);
ALTER TABLE gaming_match ADD COLUMN trait_uuids             VARCHAR(512);
