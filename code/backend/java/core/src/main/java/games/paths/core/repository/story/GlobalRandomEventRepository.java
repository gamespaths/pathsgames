 ...
 */
@Repository
public interface GlobalRandomEventRepository extends JpaRepository<GlobalRandomEventEntity, StoryScopedEntityId> {
    ...
    Optional<GlobalRandomEventEntity> findByIdStoryAndUuid(Long idStory, String uuid);
