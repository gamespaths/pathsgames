 ...
 */
@Repository
public interface MissionStepRepository extends JpaRepository<MissionStepEntity, StoryScopedEntityId> {
    ...
    Optional<MissionStepEntity> findByIdStoryAndUuid(Long idStory, String uuid);
