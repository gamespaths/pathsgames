-- =============================================
-- Paths Games - Database Schema V0.37.0 (SQLite)
...
-- Neither column is indexed nor named by a foreign key, so SQLite (>= 3.35) drops them in place.
...
ALTER TABLE list_missions_steps ADD COLUMN condition_value TEXT;
ALTER TABLE list_missions_steps ADD COLUMN condition_values TEXT;
