...
-- =============================================
-- SEED DATA: DEMO Stories for Development
...
INSERT INTO list_stories_difficulty (id, id_story, uuid, id_text_description, exp_cost, max_weight, min_character, max_character, cost_help_coma, cost_max_characteristics, number_max_free_action, life, energy, sad, dexterity, intelligence, constitution, weight, trait_cost_positive_budget, trait_cost_negative_budget) VALUES
(90001, 9001, 'db0d83f2-0ed6-437a-a55b-e110f4040273', 300, 1, 20, 1, 4, 1, 1, 3, 120, 110, 0, 12, 12, 12, 12, 2, 3);
...
INSERT INTO list_character_templates (id_story, id_tipo, id_text_name, id_text_description, life_max, energy_max, sad_max, dexterity_start, intelligence_start, constitution_start, id_class_permitted, id_class_prohibited) VALUES
(9001, 90001, 210, 210, 12, 12, 8, 3, 3, 3, NULL,  NULL);
INSERT INTO list_character_templates (id_story, id_tipo, id_text_name, id_text_description, life_max, energy_max, sad_max, dexterity_start, intelligence_start, constitution_start, id_class_permitted, id_class_prohibited) VALUES
(9001, 90002, 211, 211, 10, 10, 6, 2, 5, 2, 90002, NULL);
INSERT INTO list_character_templates (id_story, id_tipo, id_text_name, id_text_description, life_max, energy_max, sad_max, dexterity_start, intelligence_start, constitution_start, id_class_permitted, id_class_prohibited) VALUES
(9001, 90003, 212, 212, 11, 14, 7, 5, 2, 4, NULL,  90001);
...
INSERT INTO list_locations_neighbors (id, id_story, id_location_from, id_location_to, direction, energy_cost) VALUES
...
-- Story 1 Items
INSERT INTO list_items (id, id_story, id_text_name, id_text_description, weight) VALUES
...
INSERT INTO list_items_effects (id, id_story, id_item, effect_type, effect_value) VALUES
(90001, 9001, 90001, 'LIFE', 3);
INSERT INTO list_items_effects (id, id_story, id_item, effect_type, effect_value) VALUES
...
INSERT INTO list_weather_rules (id, id_story, id_text_name, probability, delta_energy, is_active) VALUES
...
-- Story 1 Events
INSERT INTO list_events (id, id_story, id_text_name, id_text_description, event_type, energy_cost, flag_end_time) VALUES
...
INSERT INTO list_events_effects (id, id_story, id_event, effect_type, effect_value) VALUES
...
-- Story 1 Choices
INSERT INTO list_choices (id, id_story, id_event, priority, id_text_name, id_text_description, is_otherwise, is_progress) VALUES
...
INSERT INTO list_choices_conditions (id, id_story, id_choice, condition_type, condition_key, condition_value, condition_operator) VALUES
(90001, 9001, 90003, 'statistics', 'int', '1', '>');

-- Story 1 Choice Effects
INSERT INTO list_choices_effects (id, id_story, id_choice, effect_type, effect_value) VALUES
...
INSERT INTO list_global_random_events (id, id_story, probability) VALUES
(90001, 9001, 10);
...
INSERT INTO list_missions (id, id_story, condition_key, condition_value_to, id_text_name, id_text_description) VALUES
(90002, 9001, 'items_collected', 'true', 901, 901);
INSERT INTO list_missions (id, id_story, condition_key, condition_value_to, id_text_name, id_text_description) VALUES
(90003, 9001, 'choice_made', 'gold', 902, 902);

-- Story 1 Mission Steps
INSERT INTO list_missions_steps (id, id_story, id_mission, step_order, condition_key, condition_value) VALUES
...
INSERT INTO list_character_templates (id_story, id_tipo, id_text_name, id_text_description, life_max, energy_max, sad_max, dexterity_start, intelligence_start, constitution_start, id_class_permitted, id_class_prohibited) VALUES
(9002, 91001, 210, 210, 12, 10, 8, 3, 3, 4, NULL,  NULL);
INSERT INTO list_character_templates (id_story, id_tipo, id_text_name, id_text_description, life_max, energy_max, sad_max, dexterity_start, intelligence_start, constitution_start, id_class_permitted, id_class_prohibited) VALUES
(9002, 91002, 211, 211, 8, 8, 6, 1, 5, 2, 91002, NULL);
INSERT INTO list_character_templates (id_story, id_tipo, id_text_name, id_text_description, life_max, energy_max, sad_max, dexterity_start, intelligence_start, constitution_start, id_class_permitted, id_class_prohibited) VALUES
(9002, 91003, 212, 212, 14, 12, 10, 4, 1, 5, NULL,  91001);
