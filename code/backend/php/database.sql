...
CREATE TABLE IF NOT EXISTS list_stories_difficulty (
    ...
    trait_cost_positive_budget INT DEFAULT NULL,
    trait_cost_negative_budget INT DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS gaming_match (
    ...
    single_player INT NOT NULL DEFAULT 1,
    character_template_uuid VARCHAR(36) DEFAULT NULL,
    class_uuid VARCHAR(36) DEFAULT NULL,
    trait_uuids VARCHAR(512) DEFAULT NULL,
    ts_insert DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    ts_update DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
