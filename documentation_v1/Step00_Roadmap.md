# Paths Games V1 - Roadmap & Todo-List

This document defines the **project plan** to build a **Paths Games**, an playable web-based game, with detailed requirements and scope for a V1 release.
